...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-blue-100 flex flex-col items-center px-4 py-10 font-manrope text-center">
      ...
      <div className="bg-white rounded-xl shadow-md p-6 mb-10 max-w-xl mx-auto">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 justify-center gap-6">
        {cards.map((card) => (
          <div
            ...
            className="bg-white rounded-xl shadow-md p-6 cursor-pointer hover:shadow-lg transition text-center"
          >
